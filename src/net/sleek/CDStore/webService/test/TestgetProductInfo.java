...
public class TestgetProductInfo {
	...
	private int productId;//the parameter of getProductinfo
	 ...
	 */
    public TestgetProductInfo(int productId, String result){
	...
	/**
	 * Test method for {@link net.sleek.CDStore.webService.category.CategoryService#getProductInfo(int)}.
	 */
	@Test
